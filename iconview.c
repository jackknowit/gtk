...
GtkTreeModel* init_model(void) {
  ...
  p1 = gdk_pixbuf_new_from_file("IMG_0884.png", &err); 
  p2 = gdk_pixbuf_new_from_file("IMG_0884.png", &err);
  p3 = gdk_pixbuf_new_from_file("IMG_0884.png", &err);
  p4 = gdk_pixbuf_new_from_file("IMG_0884.png", &err);
